        ...
        <div className="space-y-12 animate-fade-in-up">
            ...
            <div className="relative w-full h-64 rounded-3xl overflow-hidden shadow-2xl group">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-8">
                    <h1 className="text-6xl font-black text-white tracking-tight drop-shadow-lg">Arts <span className="text-blue-400">2025</span></h1>
                    <p className="text-gray-300 text-lg mt-2 font-medium">Fine Arts Festival Scoreboard</p>
                </div>
            </div>
